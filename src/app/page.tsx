...
export default function HomePage() {
  ...
  const [mounted,  setMounted]  = useState(true);   // scan line trigger
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {loading && (
            <div
              ...
              style={{ borderColor: "rgba(240,165,0,0.2)", background: "rgba(240,165,0,0.04)" }}
            >
              {/* Step label with blinking cursor */}
              <div className="flex items-center gap-3">
                <div
              ...
              <div className="flex gap-1.5">
                {STEPS.map((_, i) => (
                  <div
                    ...
                    style={{
                      background: i <= step ? "var(--ember)" : "rgba(255,255,255,0.06)",
              ...
              <p className="sec-label">
                Step {step + 1}/{STEPS.length} · This takes 20–40 seconds
              </p>
            </div>
          )}
